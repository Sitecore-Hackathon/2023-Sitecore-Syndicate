...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.sitecoresyndicate.localhost/ --auth https://id.sitecoresyndicate.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.sitecoresyndicate.localhost/ --auth https://id.sitecoresyndicate.localhost/ --allow-write true
}
...
Start-Process https://cm.sitecoresyndicate.localhost/sitecore/
Start-Process https://www.sitecoresyndicate.localhost/
